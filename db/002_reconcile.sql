...
-- DEFERRED to db/004 (do NOT do here): the route_stops address-level
...
-- ============================================================================
-- DEFERRED to db/004 — DO NOT IMPLEMENT HERE.
-- ----------------------------------------------------------------------------
...
-- Track it as db/004. (route_stops today still references response_id +
