...
-- DEFERRED to db/003 (do NOT do here): the route_stops address-level
...
-- ============================================================================
-- DEFERRED to db/003 — DO NOT IMPLEMENT HERE.
-- ----------------------------------------------------------------------------
...
-- Track it as db/003. (route_stops today still references response_id +
