...
-- DEFERRED to db/005 (do NOT do here): the route_stops address-level
...
-- ============================================================================
-- DEFERRED to db/005 — DO NOT IMPLEMENT HERE.
-- ----------------------------------------------------------------------------
...
-- Track it as db/005. (route_stops today still references response_id +
