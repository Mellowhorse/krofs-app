...
-- DEFERRED to db/008 (do NOT do here): the route_stops address-level
...
-- ============================================================================
-- DEFERRED to db/008 — DO NOT IMPLEMENT HERE.
-- ----------------------------------------------------------------------------
...
-- Track it as db/008. (route_stops today still references response_id +
